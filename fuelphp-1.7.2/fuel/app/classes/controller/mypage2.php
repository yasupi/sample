<?php
class Controller_Mypage2 extends Controller_Common {
	public function action_index() {
		Asset::css(array('modalOfMypage.css', 'menuTabOfMypage.css'), array(), 'exclusive_css', false);
		$this->template->content = View::forge ( 'contents/mypage2' );
		// echo DOCROOT;
	}
	...
	public function action_upload() {
		...
		Response::redirect ( 'mypage2/', 'refresh' );
